...
describe("Form component", () => {
  ...
  test("should allow to send form if it is valid", () => {
    ...
    fireEvent.change(horridControl, {
      target: { value: "Horrid", checked: true },
    });

    const lovelyControl = component.getByRole("lovely-control");
    fireEvent.change(lovelyControl, {
      target: { value: "Lovely", checked: true },
    });

    const unusualControl = component.getByRole("unusual-control");
    fireEvent.change(unusualControl, {
      target: { value: "Unusual", checked: true },
    });
